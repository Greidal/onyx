...
IMAP_CONNECTOR_ATTACHMENT_SIZE_THRESHOLD = int(
    os.environ.get("IMAP_CONNECTOR_ATTACHMENT_SIZE_THRESHOLD", 10 * 1024 * 1024)
)
IMAP_CONNECTOR_ATTACHMENT_CHAR_COUNT_THRESHOLD = int(
    os.environ.get("IMAP_CONNECTOR_ATTACHMENT_CHAR_COUNT_THRESHOLD", 200_000)
)
